        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Friendship_NoSelf", "[RequesterId] <> [AddresseeId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiPickLists", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Review_Rating", "[Rating] BETWEEN 1 AND 10");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AiPickListId = table.Column<int>(type: "int", nullable: false),
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    Position = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiPickListItems", x => x.Id);
                    table.CheckConstraint("CK_AiPickListItem_Position", "[Position] BETWEEN 1 AND 10");
                    table.ForeignKey(
                        name: "FK_AiPickListItems_AiPickLists_AiPickListId",
                        column: x => x.AiPickListId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchLaterItems_UserId_MovieId",
                table: "WatchLaterItems",
                columns: new[] { "UserId", "MovieId" },
                unique: true);
        }
